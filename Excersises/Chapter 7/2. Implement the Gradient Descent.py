...
Your challenge is to implement a generic program using the gradient descent algorithm to find the
minimum value of a single-variable function  specified as input by the user.

The pgoram should also create a graph and show all the intermediate values it found
